          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.cjks }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="wtmc"
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.zrbm }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="zrks"
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.zrks }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="zrr"
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.zrr }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="yrzbm"
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.yrzbm }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="yzr"
            ...
            >
              <template slot-scope="scope">
                ...
                <span v-else>{{ scope.row.sjzrr }}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="wtzt"
...
import {
  ...
  deleteJhjlByXh, updateQuestionWDWTToZero, updateMyDoListStatus, getLDPS
