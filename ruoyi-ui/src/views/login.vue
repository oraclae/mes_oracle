  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="username">
        ...
        >
          <template #suffix>
            <div class="suffix"><img class="login-icon-img" src="../assets/images/zhanghao.png" alt=""></div>
          </template>
        </el-input>
      </el-form-item>
      <el-form-item prop="password">
        ...
        >
          <template #suffix>
            <div class="suffix"><img class="login-icon-img" src="../assets/images/mima.png" alt=""></div>
          </template>
        </el-input>
      </el-form-item>
      <el-form-item prop="code" v-if="captchaEnabled">
        ...
        >
          <template #suffix>
            <div class="suffix"><img class="login-icon-img" src="../assets/images/yanzhengma.png" alt=""></div>
          </template>
        </el-input>
